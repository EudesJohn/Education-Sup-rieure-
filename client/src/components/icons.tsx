/** Icônes SVG partagées — PEAN Deep Focus.
 *  Toutes les icônes → Heroicons outline (cohérence garantie).
 *  Usage : <DocIcon className="w-5 h-5 text-muted" /> */
...
export function FiliereIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
